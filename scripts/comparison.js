...
// Fetch all Kentucky players from local JSON file (generated by Python script)
async function loadPlayers() {
    try {
        showLoading('Loading players...');
        
        // Try to load from the generated JSON file
        const response = await fetch('../data/api-players.json');
        ...
        alert('Failed to load player data. Please run the update-player-stats.py script first to generate the data file.');
        hideLoading();
    }
}
